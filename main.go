...
func initializeGame() {
    ...
    // 设置国际象棋部分（黑方）
    currentGame.Board[9][0] = "b-R"
    currentGame.Board[9][1] = "b-N"
    currentGame.Board[9][2] = "b-B"
    currentGame.Board[9][3] = "b-Q"
    currentGame.Board[9][4] = "b-K"
    currentGame.Board[9][5] = "b-B"
    currentGame.Board[9][6] = "b-N"
    currentGame.Board[9][7] = "b-R"
    currentGame.Board[8][0] = "b-P"
    currentGame.Board[8][1] = "b-P"
    currentGame.Board[8][2] = "b-P"
    currentGame.Board[8][3] = "b-P"
    currentGame.Board[8][4] = "b-P"
    currentGame.Board[8][5] = "b-P"
    currentGame.Board[8][6] = "b-P"
    currentGame.Board[8][7] = "b-P"
    currentGame.Board[8][8] = "b-P"
